...
fraudulent behavior in web traffic running through it. If detected, 
...
Quarantyne can be configured to handle fraud on its own and prevent 
it from reaching your servers, saving you resources, metrics skew, 
